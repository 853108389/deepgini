...
def exp(model_name, coverage, use_adv, std=0.0, k=1, k_bins=1000):
    ...
    if coverage == 'kmnc':
        pass
        df.to_csv('./all_output/output_cifar/{}/{}_{}_k_bins_{}.csv'.format(model_name, dataset, coverage, k_bins))
    elif coverage == 'nbc':
        pass
        df.to_csv('./all_output/output_cifar/{}/{}_{}_std_{}.csv'.format(model_name, dataset, coverage, std))
    elif coverage == 'snac':
        pass
        df.to_csv('./all_output/output_cifar/{}/{}_{}_std_{}.csv'.format(model_name, dataset, coverage, std))
    elif coverage == 'tknc':
        pass
        df.to_csv('./all_output/output_cifar/{}/{}_{}_k_{}.csv'.format(model_name, dataset, coverage, k))
...
def exp_nac(model_name, use_adv, t):
    ...
    df.to_csv('./all_output/output_cifar/{}/{}_nac_t_{}.csv'.format(model_name, dataset, t))
...
def exp_deep_metric(model_name, use_adv):
    ...
    if use_adv:
        ...
        dataset = 'cifar'
    df.to_csv('./all_output/output_cifar/{}/{}_deep_metric.csv'.format(model_name, dataset))
...
def exec(model_name):
    ...
    # print("=========================================24")
    # print(dic)
    # path = "./all_output/{}_output_cifar_res_time.csv".format(model_name)
